...
public abstract class CalculatorPOA extends org.omg.PortableServer.Servant
 implements CalcApp.CalculatorOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // CalcApp/Calculator/subtract
       {
         int a = in.read_long ();
         int b = in.read_long ();
         int $result = (int)0;
       ...
       case 2:  // CalcApp/Calculator/multiply
       {
         int a = in.read_long ();
         int b = in.read_long ();
         int $result = (int)0;
       ...
       case 3:  // CalcApp/Calculator/divide
       {
